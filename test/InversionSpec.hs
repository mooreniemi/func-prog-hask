...
spec = do
  describe "inversions" $ do
    ...
    it "coursera test cases" $ do
      ...
      -- should this be 490, or was that a typo on coursera?
      snd (inversions ([37, 7, 2, 14, 35, 47, 10, 24, 44, 17, 34, 11, 16, 48, 1, 39, 6, 33, 43, 26, 40, 4, 28, 5, 38, 41, 42, 12, 13, 21, 29, 18, 3, 19, 0, 32, 46, 27, 31, 25, 15, 36, 20, 8, 9, 49, 22, 23, 30, 45], 50)) `shouldBe` 590
